...
description: SPA(Single Page Application)을 구현하기 위해서는 꽤나 많은 코드가 필요하다. Bundler를 구성하기 위해선 각각의 필요로 하는 기능의 Config 파일을 작성해야 한다. Vanilla JavaScript로 구현한 기능들은 코드를 상대적으로 매우 많이 필요로한다. Vanill JavaScript에서 Mark-up을 Styling 하는 것은 꽤나 귀찮게 이루어 진다. 프로젝트의 크기가 커질 수록 유지보수를 하는 것은 굉장히 어려워 진다.
date: 2022-08-30
---

> [Velog 글](https://velog.io/@haneum/2)
